...
public class PathCursor extends AbstractCursor {
    ...
    public static final String[] columnNames = new String[]{CN_ID, CN_FILE_NAME, CN_FILE_PATH, CN_IS_DIRECTORY, CN_IS_IMAGE};
...
//        sMediaExtSet.add("mp4");
        sMediaExtSet.add("jpg");
        sMediaExtSet.add("bmp");
        sMediaExtSet.add("png");
    }
